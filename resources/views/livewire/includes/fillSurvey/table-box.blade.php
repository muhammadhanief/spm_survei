            ...
            <table class="w-full whitespace-no-wrap">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-3">Nama Survey</th>
                        <th class="px-4 py-3">Dimulai Tanggal</th>
                        ...
                        <tr wire:key='{{ $survey->id }}' class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <x-button-small wire:click='fillSurvey({{ $survey->id }})' color="purple">Isi
                                        Survei </x-button-small>
                                    {{-- <button
