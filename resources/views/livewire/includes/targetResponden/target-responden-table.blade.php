        ...
        <div class="flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="justify-end flex flex-row gap-2 ">
                <button wire:click='export'
                    class="px-3 py-1 my-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-md active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green">Export</button>
                <div class="relative">
