                                ...
                                <div style="width: 14.28%; height: 120px" class="relative px-4 pt-2 border-b border-r">
                                    <div @click="showEventModal(date)" x-text="date"
                                        ...
                                        :class="{ 'bg-blue-500 text-white': isToday(date) ==
                                            true, 'text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-blue-200': isToday(
                                                date) == false }">
                                    </div>
                        ...
                        <div class="block w-full p-8 overflow-hidden bg-white rounded-lg shadow">
                            ...
                            <div class="mb-4">
                                <label class="block mb-1 text-sm font-bold tracking-wide text-gray-800">Event
                                    title</label>
                                <input
                                    class="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-gray-200 rounded-lg appearance-none dark:text-gray-300 focus:outline-none focus:bg-white focus:border-blue-500"
                            ...
                            <div class="inline-block w-64 mb-4">
                                ...
                                <div class="relative">
                                    <select @change="event_theme = $event.target.value;" x-model="event_theme"
                                        class="block w-full px-4 py-2 pr-8 leading-tight text-gray-700 bg-gray-200 border-2 border-gray-200 rounded-lg appearance-none dark:text-gray-300 hover:border-gray-500 focus:outline-none focus:bg-white focus:border-blue-500">
                            ...
                            <div class="mt-8 text-right">
                                <button type="button"
                                    class="px-4 py-2 mr-2 font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm dark:text-gray-300 hover:bg-gray-100"
